...
for i in range(0,5):
    ...
    model = build_model(    
        ...
        num_heads=2,  
        ff_dim=4,
        num_transformer_encoderblocks=5, 
    ...
    y_testorign=y_scaler.inverse_transform(data_scaled[:,1:2])[(validat_size+time_step+1):len(data_scaled),:]
...
finalmae.index=["10days","15days","20days","25days","30days"]
finalmae.to_csv(r'D:/pytorch範例/transformer_tensorflow/1002transformer/dayscode/timestep/AAPL_timestep.csv')
