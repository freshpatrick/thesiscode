...
for i in range(1,len(stocklist)):  #len(stocklist)  
    ...
    if (stockname=="AAPL"):
       ...
       os.path.exists('AAPL_15minnetwork.py')
       os.path.exists('.\daily stock')
       filepath="../daily stock"
       ../folder2
    ...
    if (stockname=="TSLA15min"):
       # Load  dataset
       output_directory = r'C:\Users\2507\Desktop\遠端資料\data\15mindata\TSLA'
       ...
       #model
       Stockmodel = StockTSLA15minModel()
       model=Stockmodel.callmodel()
    ...
    if (stockname=="StockQM"):
       # Load  dataset
      #x_bigdata=np.load('..../data/StockQM/x_bigdata.npy')       
