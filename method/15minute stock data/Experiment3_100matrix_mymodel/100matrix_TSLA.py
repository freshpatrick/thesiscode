...
output_path = os.path.join(output_directory, "15min200001.csv") 
...
bigmae.to_csv(r'D:/pytorch範例/transformer_tensorflow/1002transformer/big100MAE/TSLA/1.5最新TSLAMAE.csv')
