...
for k in range(0,5):  #len(stock_id)
    ...
    for i in tqdm.tqdm_notebook(range(0,len(train)-n)):
        ...
        x_train.append(x_trainaddscalar)  
...
big_lstm_data.to_csv(r'D:/2021 4月開始的找回程式之旅/0409論文想做的題目/0506比較方法/五個股票/MINMAXSCALAR 5050five_outputdata_lstm.csv', encoding='utf_8_sig')
