...
def transformer_encoder(inputs, head_size, num_heads, ff_dim, dropout=0):
    ...
    #Branch
    x_1 = layers.Conv1D(filters=4,kernel_size=1,padding='same',activation='tanh')(x)
    x_2 = layers.Conv1D(filters=4,kernel_size=3,padding='same',activation='tanh')(x)
...
def build_model(
    ...
    for dim in num_transformer_decoderblocks:
        ...
        x = layers.Dense(50, activation="sigmoidtanh)
        x=x_encoder+x
