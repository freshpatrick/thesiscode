...
#dropout percent
drop_per=[0.1,0.15,0.2,0.25,0.3]
mae_result=[]
...
finalmae.index=["0.1","0.15","0.2","0.25","0.3"]
finalmae.to_csv(r'D:/pytorch範例/transformer_tensorflow/1002transformer/mydata_dropoutpercent.csv')
